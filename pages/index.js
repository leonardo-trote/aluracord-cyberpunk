...
export default function HomePage() {
    ...
    function checkUsernameLen(user) {
                ...
                >
                    ...
                    <Box
                        ...
                        onSubmit={function (event) {
                            ...
                            if (checkUsernameLen(username)) {
                                ...
                                alert("Seu nome de usuário deve possuir pelo menos dois caracteres")
                            }
                        }}
                        styleSheet={{
                    ...
                    >
                        ...
                        <Image
                            ...
                            src={checkUsernameLen(username) ? `https://github.com/${username}.png` : 'https://sumaleeboxinggym.com/wp-content/uploads/2018/06/Generic-Profile-1600x1600.png'}
                        />
                        <Text
                            variant="body4"
                            styleSheet={{
